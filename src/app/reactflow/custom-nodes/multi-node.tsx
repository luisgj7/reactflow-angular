...
const MultiDecision: FunctionComponent = ({ id, data }: NodeProps): ReactElement => {
  return (
    <div className="react-flow__node-multiNode content">
      <Handle
...
export const MultiNode = memo(MultiDecision);
